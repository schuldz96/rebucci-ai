...
! function() {
    ...
    const UE = (e, t, n, o, r, s) => {
        ...
        ok = (e, t) => J(((e, t) => te((e => q(e, (e => ({ ...ek,
            ...e
        }))))(e), (e => tk(e, t) ? [e] : [])))(e, t), (e => e.action())),
        rk = (e, t) => ue(((e, t) => te((e => q(e, (e => ({ ...ek,
            ...e
        }))))(e), (e => tk(e, t) ? [e] : [])))(e, t), (e => e.action())),
        sk = (e, t) => {
            const n = t ? cu.Forwards : cu.Backwards,
    ...
    const AA = (e, t) => Math.abs(e.left - t),
        ...
        jT = za.DOM,
        HT = e => "-" === e.charAt(0),
        $T = (e, t, n) => I.from(t).filter((e => Ye(e) && !xw.has(e))).map((t => ({
        ...
        rO = Xt("font"),
        sO = e => (t, n) => I.from(n).map(yn).filter(Wt).bind((n => ((e, t, n) => Lb(yn(n), (t => (t => mo(t, e).orThunk((() => rO(t) ? xe(oO, e).bind((e => tn(t, e))) : I.none())))(t)), (e => _n(yn(t), e))))(e, t, n.dom).or(((e, t) => I.from(za.DOM.getStyle(t, e, !0)))(e, n.dom)))).getOr(""),
        aO = sO("font-size"),
        iO = k((e => e.replace(/[\'\"\\]/g, "").replace(/,\s+/g, ",")), sO("font-family")),
        lO = e => Ou(e.getBody()).bind((e => {
            const t = e.container();
        ...
        })))(e).orThunk(T(lO, e)).map(yn).filter(Wt).bind(t))(e, S(I.some, t)),
        cO = (e, t) => {
            if (/^[0-9.]+$/.test(t)) {
