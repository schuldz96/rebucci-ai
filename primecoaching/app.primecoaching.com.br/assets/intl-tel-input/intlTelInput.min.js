...
(function(factory) {
    ...
    var factoryOutput = (() => {
        ...
        var K2 = 0,
            ...
            b1 = class {
                constructor(e, n = {}) {
                    this.id = K2++, this.telInput = e, this.highlightedItem = null, this.options = Object.assign({}, p2, n), this.hadInitialPlaceholder = !!e.getAttribute("placeholder")
                }
                _init() {
                    ...
                    this.showSelectedCountryOnLeft = this.isRTL ? !e : e, this.options.separateDialCode && (this.isRTL ? this.originalPaddingRight = this.telInput.style.paddingRight : this.originalPaddingLeft = this.telInput.style.paddingLeft), this.options.i18n = { ..._1,
                        ...this.options.i18n
                    };
                ...
                _generateMarkup() {
                    ...
                    e && (L += " iti--allow-dropdown"), r && (L += " iti--show-flags"), u && (L += ` ${u}`), m || (L += " iti--inline-dropdown");
                    let b = T("div", {
                        class: L
                    });
                    if (this.telInput.parentNode ? .insertBefore(b, this.telInput), e || r || n) {
                        this.countryContainer = T("div", {
                        ...
                        }, b), this.showSelectedCountryOnLeft ? this.countryContainer.style.left = "0px" : this.countryContainer.style.right = "0px", e ? (this.selectedCountry = T("button", {
                            type: "button",
                            ...
                            role: "combobox"
                        }, this.countryContainer), this.telInput.disabled && this.selectedCountry.setAttribute("disabled", "true")) : this.selectedCountry = T("div", {
                            class: "iti__selected-country"
                ...
                _appendListItems() {
                    for (let e = 0; e < this.countries.length; e++) {
                        ...
                        let l = "";
                        this.options.showFlags && (l += `<div class='iti__flag iti__${n.iso2}'></div>`), l += `<span class='iti__country-name'>${n.name}</span>`, l += `<span class='iti__dial-code'>+${n.dialCode}</span>`, u.insertAdjacentHTML("beforeend", l)
                    }
                }
                ...
                _initRequests() {
                    ...
                    }, f.documentReady() ? this._handlePageLoad() : window.addEventListener("load", this._handlePageLoad)) : this.resolveUtilsScriptPromise(), n === "auto" && r && !this.selectedCountryData.iso2 ? this._loadAutoCountry() : this.resolveAutoCountryPromise()
                }
                _loadAutoCountry() {
                    f.autoCountry ? this.handleAutoCountry() : f.startedLoadingAutoCountry || (f.startedLoadingAutoCountry = !0, typeof this.options.geoIpLookup == "function" && this.options.geoIpLookup((e = "") => {
                        let n = e.toLowerCase();
                        n && this._getCountryData(n, !0) ? (f.autoCountry = n, setTimeout(() => e1("handleAutoCountry"))) : (this._setInitialState(!0), e1("rejectAutoCountryPromise"))
                    }, () => {
                ...
                _initTelInputListeners() {
                    ...
                    }, this.telInput.addEventListener("input", this._handleInputEvent), (e || r) && (this._handleKeydownEvent = m => {
                ...
                _bindDropdownListeners() {
                    ...
                    }, this.countryList.addEventListener("mouseover", this._handleMouseoverCountryList), this._handleClickCountryList = u => {
                        let l = u.target ? .closest(".iti__country");
                    ...
                    if (this._handleKeydownOnDropdown = u => {
                        ...
                        }, this.searchInput.addEventListener("input", this._handleSearchChange), this.searchInput.addEventListener("click", p => p.stopPropagation())
                    }
                }
                _searchForCountry(e) {
                ...
                _setCountry(e) {
                    ...
                    if (this.selectedCountryData = e ? this._getCountryData(e, !1) || {} : {}, this.selectedCountryData.iso2 && (this.defaultCountry = this.selectedCountryData.iso2), this.selectedCountryInner) {
                        let p = "",
                            y = "";
                        e && r ? (p = `iti__flag iti__${e}`, y = `${this.selectedCountryData.name} +${this.selectedCountryData.dialCode}`) : (p = "iti__flag iti__globe", y = u.noCountrySelected), this.selectedCountryInner.className = p, this.selectedCountryA11yText.textContent = y
                    }
                ...
                _updatePlaceholder() {
                    ...
                    if (f.utils && l) {
                        ...
                        y = this._beforeSetNumber(y), typeof u == "function" && (y = u(y, this.selectedCountryData)), this.telInput.setAttribute("placeholder", y)
                    }
                }
                _selectListItem(e) {
                ...
                destroy() {
                    ...
                    u ? .parentNode ? .insertBefore(this.telInput, u), u ? .parentNode ? .removeChild(u), delete f.instances[this.id]
                }
                getExtension() {
            ...
            W2 = g => {
                if (!f.utils && !f.startedLoadingUtilsScript) {
                    ...
                    } else return Promise.reject(new TypeError(`The argument passed to attachUtils must be a function that returns a promise for the utilities module, not ${typeof g}`));
                    return f.startedLoadingUtilsScript = !0, e.then(n => {
                        let r = n ? .default;
                        if (!r || typeof r != "object") throw new TypeError("The loader function passed to attachUtils did not resolve to a module object with utils as its default export.");
        ...
        (function() {
            ...
            function n(d, t) {
                function $() {}
                $.prototype = t.prototype, d.ma = t.prototype, d.prototype = new $, d.prototype.constructor = d, d.sa = function(i, o, s) {
            ...
            r1.prototype.g = function(d) {
                ...
                } else if (d === Number && typeof t == "string" && (t === "Infinity" || t === "-Infinity" || t === "NaN" || E1.test(t))) return Number(t);
                return t
            };
            var E1 = /^-?[0-9]+$/;
            ...
            function o1(d, t) {
                for (var $ = new w, i, o = d.length, s = 0; s < o; ++s) i = d.charAt(s), i = t[i.toUpperCase()], i != null && $.g(i);
                return $.toString()
            }
            ...
            M.prototype.format = function(d, t) {
                ...
                return o != null && (a = o, o = v(a, 2), s = new RegExp(c(a, 1)), v(a, 5), a = v(a, 4), i = t == 2 && a != null && 0 < a.length ? i.replace(s, o.replace(E2, a)) : i.replace(s, o), t == 3 && (i = i.replace(RegExp("^[-x\u2010-\u2015\u2212\u30FC\uFF0D-\uFF0F \xA0\xAD\u200B\u2060\u3000()\uFF08\uFF09\uFF3B\uFF3D.\\[\\]/~\u2053\u223C\uFF5E]+"), ""), i = i.replace(RegExp("[-x\u2010-\u2015\u2212\u30FC\uFF0D-\uFF0F \xA0\xAD\u200B\u2060\u3000()\uFF08\uFF09\uFF3B\uFF3D.\\[\\]/~\u2053\u223C\uFF5E]+", "g"), "-"))), F1($, t, i, d)
            };
            ...
            function a1(d, t, $, i) {
                ...
                if (o = D(o, 10), i == 2)
                    if (G1(u1($, 0))) d = u1($, 1), G1(d) && (s = s.concat(G(d, 9) == 0 ? D(c($, 1), 9) : D(d, 9)), s.sort(), o.length == 0 ? o = D(d, 10) : (o = o.concat(D(d, 10)), o.sort()));
                    else return a1(d, t, $, 1);
                return s[0] == -1 ? 5 : (t = t.length, -1 < o.indexOf(t) ? 4 : ($ = s[0], $ == t ? 0 : $ > t ? 2 : s[s.length - 1] < t ? 3 : -1 < s.indexOf(t, 1) ? 0 : 5))
            }
            ...
            function z1(d, t, $, i, o, s) {
                ...
                return $ != null && (a = v($, 10), h = "" + a, C = t.toString(), C.lastIndexOf(h, 0) == 0 && (h = new w(C.substring(h.length)), C = c($, 1), C = new RegExp(v(C, 2)), Z1(h, $, null), h = h.toString(), !B(C, t.toString()) && B(C, h) || a1(d, t.toString(), $, -1) == 3)) ? (i.g(h), o && A(s, 6, 10), A(s, 1, a), a) : (A(s, 1, 0), 0)
            }
            ...
            function Z1(d, t, $) {
                ...
                if (o != 0 && s != null && s.length != 0) {
                    ...
                    if (o = a.exec(i)) {
                        ...
                        var h = B(s, i),
                            C = o.length - 1;
                        t = c(t, 16), t == null || t.length == 0 || o[C] == null || o[C].length == 0 ? (!h || B(s, i.substring(o[0].length))) && ($ != null && 0 < C && o[C] != null && $.g(o[1]), d.set(i.substring(o[0].length))) : (i = i.replace(a, t), (!h || B(s, i)) && ($ != null && 0 < C && $.g(o[1]), d.set(i)))
                    }
                }
            }
            ...
            function Y1(d, t, $, i) {
                ...
                var h = s;
                if (h == null ? a = !0 : h.length === 0 ? a = !1 : (a = L2.exec(h), h = w2.exec(h), a = a !== null || h !== null), !a || (s != null ? (s.charAt(0) === "+" && o.g(s), s = t.indexOf("tel:"), o.g(t.substring(0 <= s ? s + 4 : 0, t.indexOf(";phone-context=")))) : (s = o.g, a = t ? ? "", h = a.search(I2), 0 <= h ? (a = a.substring(h), a = a.replace(b2, ""), h = a.search(_2), 0 <= h && (a = a.substring(0, h))) : a = "", s.call(o, a)), s = o.toString(), a = s.indexOf(";isub="), 0 < a && (R(o), o.g(s.substring(0, a))), !k1(o.toString()))) throw Error("The string supplied did not seem to be a phone number");
                if (s = o.toString(), !(s1($) || s != null && 0 < s.length && X.test(s))) throw Error("Invalid country calling code");
                s = new U, i && A(s, 5, t);
                d: {
                ...
                if (h != 0 ? (o = t1(h), o != $ && (a = Q(d, h, o))) : (H1(o), t.g(o.toString()), $ != null ? (h = v(a, 10), A(s, 1, h)) : i && (delete s.h[6], s.g && delete s.g[6])), 2 > t.h.length || (a != null && ($ = new w, o = new w(t.toString()), Z1(o, a, $), d = a1(d, o.toString(), a, -1), d != 2 && d != 4 && d != 5 && (t = o, i && 0 < $.toString().length && A(s, 7, $.toString()))), i = t.toString(), d = i.length, 2 > d)) throw Error("The string supplied is too short to be a phone number");
            ...
            function M2(d) {
                this.fa = RegExp("\u2008"), this.ja = "", this.v = new w, this.da = "", this.s = new w, this.ba = new w, this.u = !0, this.ea = this.ca = this.la = !1, this.ga = M.g(), this.$ = 0, this.h = new w, this.ha = !1, this.o = "", this.g = new w, this.j = [], this.ka = d, this.l = X1(this, this.ka)
            }
            var J1 = new j;
            A(J1, 11, "NA");
            ...
            function Q1(d) {
                for (var t = d.j.length, $ = 0; $ < t; ++$) {
                    ...
                    if (H.length < C.g.h.length ? C = "" : (C = H.replace(new RegExp(h, "g"), a), C = C.replace(RegExp("9", "g"), "\u2008")), 0 < C.length ? (s.v.g(C), s = !0) : s = !1, s) return d.da = o, d.ha = q1.test(c(i, 4)), d.$ = 0, !0
                }
                return d.u = !1
            }
            ...
            function P2(d, t) {
                d.s.g(t);
                var $ = t;
                if (x1.test($) || d.s.h.length == 1 && v2.test($) ? (t == "+" ? ($ = t, d.ba.g(t)) : ($ = g1[t], d.ba.g($), d.g.g($)), t = $) : (d.u = !1, d.la = !0), !d.u) {
                    if (!d.la) {
                        if (i2(d)) {
                            if (r2(d)) return t2(d)
                        } else if (0 < d.o.length && (t = d.g.toString(), R(d.g), d.g.g(d.o), d.g.g(t), t = d.h.toString(), $ = t.lastIndexOf(d.o), R(d.h), d.h.g(t.substring(0, $))), d.o != n2(d)) return d.h.g(" "), t2(d)
                    }
                    return d.s.toString()
                }
                switch (d.ba.h.length) {
                    ...
                    default:
                        return d.ea ? (r2(d) && (d.ea = !1), d.h.toString() + d.g.toString()) : 0 < d.j.length ? (t = o2(d, t), $ = e2(d), 0 < $.length ? $ : (d2(d, d.g.toString()), Q1(d) ? $2(d) : d.u ? h1(d, t) : d.s.toString())) : C1(d)
                }
            }
            ...
            function e2(d) {
                for (var t = d.g.toString(), $ = d.j.length, i = 0; i < $; ++i) {
                    var o = d.j[i],
                        s = v(o, 1);
                    if (new RegExp("^(?:" + s + ")$").test(t) && (d.ha = q1.test(c(o, 4)), o = t.replace(new RegExp(s, "g"), c(o, 2)), o = h1(d, o), o1(o, C2) == d.ba)) return o
                }
                return ""
            }
            ...
            function n2(d) {
                ...
                return i ? ($ = 1, d.h.g("1").g(" "), d.ca = !0) : x(d.l, 15) && (i = new RegExp("^(?:" + c(d.l, 15) + ")"), i = t.match(i), i != null && i[0] != null && 0 < i[0].length && (d.ca = !0, $ = i[0].length, d.h.g(t.substring(0, $)))), R(d.g), d.g.g(t.substring($)), t.substring(0, $)
            }
            ...
            function r2(d) {
                ...
                var t = new w,
                    $ = W1(d.g, t);
                return $ == 0 ? !1 : (R(d.g), d.g.g(t.toString()), t = t1($), t == "001" ? d.l = F(d.ga, "" + $) : t != d.ka && (d.l = X1(d, t)), d.h.g("" + $).g(" "), d.o = "", !0)
            }
